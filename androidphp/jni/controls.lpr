library controls;        //[by LAMW [GUI]:22/06/2025 07:45:02]
...
uses
  ...
  Laz_And_Controls_Events, uutama, utambah, uupdate, uupload, ugetdata;
  
{%region /fold 'LAMW generated code'}

{ Class:     id_tauhidslab_androidphp_androidphp_Controls
  Method:    pAppOnCreate
...
begin
  Java_Event_pAppOnCreate(PEnv, this, context, layout, intent); MUtama.Reinit;
end;
...
const NativeMethods: array[0..70] of JNINativeMethod = (
   (name: 'pAppOnCreate';
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     gjClass:= (curEnv^).FindClass(curEnv, 'id/tauhidslab/androidphp/'
       +'androidphp/Controls');
     gjClass:= (curEnv^).NewGlobalRef(curEnv, gjClass);
     rc := RegisterNativeMethods(curEnv, 'id/tauhidslab/androidphp/androidphp/'
       +'Controls');
     if (rc <> JNI_OK) then result := rc;
  end;
  gjClassName:= 'id/tauhidslab/androidphp/androidphp/Controls';
...
exports
  ...
  pAppOnCreate name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnStart',
  pAppOnStop name 
    'Java_id_tauhidslab_androidphp_androidphp_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_id_tauhidslab_androidphp_androidphp_Controls'
    +'_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnDraw',
  pOnTouch name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnTouch',
  pOnClickGeneric name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_id_tauhidslab_androidphp_androidphp_Controls'
    +'_pAppOnSpecialKeyDown',
  pOnDown name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnDown',
  pOnUp name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnUp',
  pOnClick name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnClick',
  pOnLongClick name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnChange',
  pOnChanged name 
    'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnChanged',
  pOnEnter name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnEnter',
  pOnBackPressed name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnBackPressed',
  pOnDone name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnDone',
  pOnSearch name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnSearch',
  pOnNext name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnNext',
  pOnGo name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnGo',
  pOnClose name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnClose',
  pAppOnViewClick name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnLostFocus',
  pOnFocus name 'Java_id_tauhidslab_androidphp_androidphp_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_id_tauhidslab_androidphp_androidphp_Controls'
    +'_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_id_tauhidslab_androidphp_androidphp'
    +'_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnRunOnUiThread',
  pEditTextOnActionIconTouchUp name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pEditTextOnActionIconTouchUp',
  pEditTextOnActionIconTouchDown name 'Java_id_tauhidslab_androidphp_'
    +'androidphp_Controls_pEditTextOnActionIconTouchDown',
  pOnHttpClientContentResult name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnHttpClientCodeResult',
  pOnHttpClientUploadProgress name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnHttpClientUploadProgress',
  pOnHttpClientUploadFinished name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnHttpClientUploadFinished',
  pOnClickWidgetItem name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnClickWidgetItem',
  pOnClickImageItem name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnClickImageItem',
  pOnClickCaptionItem name 'Java_id_tauhidslab_androidphp_androidphp_Controls_'
    +'pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_id_tauhidslab_androidphp_androidphp_Controls'
    +'_pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_id_tauhidslab_androidphp_'
    +'androidphp_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_id_tauhidslab_androidphp_'
    +'androidphp_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemCustomFont name 'Java_id_tauhidslab_androidphp_androidphp'
    +'_Controls_pOnListViewDrawItemCustomFont',
  pOnListViewDrawItemBackgroundColor name 'Java_id_tauhidslab_androidphp_'
    +'androidphp_Controls_pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_id_tauhidslab_androidphp_androidphp_'
    +'Controls_pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_id_tauhidslab_androidphp_androidphp'
    +'_Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_id_tauhidslab_androidphp_'
    +'androidphp_Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_id_tauhidslab_androidphp_androidphp'
    +'_Controls_pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_id_tauhidslab_androidphp_'
    +'androidphp_Controls_pOnListViewDrawItemWidgetImage';
...
begin
  ...
  gjAppName:= 'id.tauhidslab.androidphp.androidphp';
  gjClassName:= 'id/tauhidslab/androidphp/androidphp/Controls';
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TMUtama, MUtama);
end.
